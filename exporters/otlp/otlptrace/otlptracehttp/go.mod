module github.com/jhannah-mm/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp
...
replace github.com/jhannah-mm/opentelemetry-go/exporters/otlp/otlptrace/otlptracehttp => ./
