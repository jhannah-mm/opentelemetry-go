module github.com/jhannah-mm/opentelemetry-go/internal/metric
...
replace github.com/jhannah-mm/opentelemetry-go/internal/metric => ./
...
replace github.com/jhannah-mm/opentelemetry-go/internal/tools => ../tools
