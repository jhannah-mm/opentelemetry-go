// Deprecated: use github.com/jhannah-mm/opentelemetry-go/sdk/metric instead.
module github.com/jhannah-mm/opentelemetry-go/sdk/export/metric
...
replace github.com/jhannah-mm/opentelemetry-go/sdk/export/metric => ./
