module github.com/jhannah-mm/opentelemetry-go/example/zipkin

go 1.16

replace (
	github.com/jhannah-mm/opentelemetry-go => ../..
	github.com/jhannah-mm/opentelemetry-go/exporters/zipkin => ../../exporters/zipkin
	github.com/jhannah-mm/opentelemetry-go/sdk => ../../sdk
)

require (
	github.com/jhannah-mm/opentelemetry-go v1.4.1
	github.com/jhannah-mm/opentelemetry-go/exporters/zipkin v1.4.1
...
replace github.com/jhannah-mm/opentelemetry-go/example/zipkin => ./
