module github.com/jhannah-mm/opentelemetry-go/example/otel-collector
...
require (
	...
	github.com/jhannah-mm/opentelemetry-go/exporters/otlp/otlptrace/otlptracegrpc v1.4.1
...
replace github.com/jhannah-mm/opentelemetry-go/example/otel-collector => ./
