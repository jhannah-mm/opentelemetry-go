module github.com/jhannah-mm/opentelemetry-go/example/prometheus

go 1.16

replace (
	github.com/jhannah-mm/opentelemetry-go => ../..
	github.com/jhannah-mm/opentelemetry-go/exporters/prometheus => ../../exporters/prometheus
	github.com/jhannah-mm/opentelemetry-go/sdk => ../../sdk
)

require (
	github.com/jhannah-mm/opentelemetry-go v1.4.1
	github.com/jhannah-mm/opentelemetry-go/exporters/prometheus v0.27.0
...
replace github.com/jhannah-mm/opentelemetry-go/example/prometheus => ./
