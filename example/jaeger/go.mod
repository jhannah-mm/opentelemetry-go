module github.com/jhannah-mm/opentelemetry-go/example/jaeger

go 1.16

replace (
	github.com/jhannah-mm/opentelemetry-go => ../..
	github.com/jhannah-mm/opentelemetry-go/exporters/jaeger => ../../exporters/jaeger
	github.com/jhannah-mm/opentelemetry-go/sdk => ../../sdk
)

require (
	github.com/jhannah-mm/opentelemetry-go v1.4.1
	github.com/jhannah-mm/opentelemetry-go/exporters/jaeger v1.4.1
...
replace github.com/jhannah-mm/opentelemetry-go/example/jaeger => ./
